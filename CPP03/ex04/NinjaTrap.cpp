...
void NinjaTrap::rangedAttack(const std::string &target) {
	std::cout << "NinjaTrap " << _name << " attacks " << target << " at range, causing " << _rangedAttackDamage << " point of damage!\n";
}

void NinjaTrap::meleeAttack(const std::string &target) {
	std::cout << "NinjaTrap " << _name << " attacks " << target << " at melee, causing " << _meleeAttackDamage << " point of damage!\n";
}
